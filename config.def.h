 ...
 */
static char *font = "Monaspace Argon:pixelsize=15:antialias=true:autohint=true";
static char *font2[] = { "Symbols Nerd Font Mono:pixelsize=15:antialias=true:autohint=true", "JuliaMono:pixelsize=15:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=15:antialias=true:autohint=true", "" };
